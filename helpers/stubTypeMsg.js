        ...
        if(cfg.welcome == "text"){
          ...
          let welcome = {
            ...
            contextInfo: { 
                externalAdReply: {
                    ...
                    thumbnailUrl: pp,
                    sourceUrl: "https://github.com/rrykarlsefni",
                    mediaUrl: `http://ẉa.me/6288802752781/${Math.floor(Math.random() * 100000000000000000)}`,
                ...
                forwardedNewsletterMessageInfo: {
                    newsletterJid: "120363378175074413@newsletter",
                    serverMessageId: 152
                },
         ...
         Exp.relayMessage(cht.id, {
           "orderMessage": {
             ...
             "sellerJid": "6288802752781@s.whatsapp.net",
         ...
         Exp.relayMessage(cht.id, {
          "productMessage": {
            ...
            "businessOwnerJid": "6288802752781@s.whatsapp.net",
              "contextInfo": {
                "expiration": 86400,
